 ...
 *
 * To use: import desired functions from module, or import entire module on main and use functions from globalThis.
...
function packRoomName(roomName: string): string {
  if (PERMACACHE._packedRoomNames![roomName] === undefined) {
    const coordinateRegex = /(E|W)(\d+)(N|S)(\d+)/;
    const match = coordinateRegex.exec(roomName) as RegExpExecArray;
    const xDir = match[1];
...
globalThis.packId = packId;
globalThis.unpackId = unpackId;
globalThis.packIdList = packIdList;
globalThis.unpackIdList = unpackIdList;
globalThis.packCoord = packCoord;
globalThis.unpackCoord = unpackCoord;
globalThis.unpackCoordAsPos = unpackCoordAsPos;
globalThis.packCoordList = packCoordList;
globalThis.unpackCoordList = unpackCoordList;
globalThis.unpackCoordListAsPosList = unpackCoordListAsPosList;
globalThis.packPos = packPos;
globalThis.unpackPos = unpackPos;
globalThis.packPosList = packPosList;
globalThis.unpackPosList = unpackPosList;
globalThis.packRoomName = packRoomName;
globalThis.unpackRoomName = unpackRoomName;
