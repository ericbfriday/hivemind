...
export interface LinkDestinationTask extends StructureDestinationTask {
    type: 'link'
    target: Id<StructureLink>
}

export default LinkDestination;
export class LinkDestination extends StructureDestination<LinkDestinationTask> {
    ...
    getTasks(context: ResourceDestinationContext) {
        ...
        if (this.room.linkNetwork.energy >= this.room.linkNetwork.minEnergy) {
            return [];
        }
        ...
        return this.cacheEmptyTaskListFor(context.resourceType || '', 10, () => {
