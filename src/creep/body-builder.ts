...
export type MovementMode = typeof MOVEMENT_MODE_ROAD
...
export type BodyWeights = Partial<Record<BodyPartConstant, number>>;
export type PartCounts = Partial<Record<BodyPartConstant, number>>;
    ...
    private getGeneratedFatigue(part: BodyPartConstant) {
        ...
        switch (this.moveMode) {
            ...
            default:
            {
                ...
                throw new Error('Invalid movement mode given.');
            }
        }
    }
