...
import type RoomOperation from 'operation/room';
...
declare global {
    ...
    export interface TypedOperationsList {
    ...
    export interface DefaultOperationMemory extends OperationMemory {
        type: 'default'
    }
}
...
export class Operation {
    ...
    private squashStats() {
        if (this.memory.statTicks < 10_000) {
            return;
        }
