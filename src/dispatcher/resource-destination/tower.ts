...
export interface TowerDestinationTask extends StructureDestinationTask {
    type: 'tower'
    target: Id<StructureTower>
}

export class TowerDestination extends StructureDestination<TowerDestinationTask> {
...
export default TowerDestination;
