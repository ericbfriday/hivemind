...
declare global {
  ...
  export interface ClaimerCreepMemory extends CreepMemory {
    role: 'claimer'
    mission: 'claim' | 'reserve'
    target: string
  }

  export interface ClaimerCreepHeapMemory extends CreepHeapMemory {
  }
}

export default ClaimerRole;
export class ClaimerRole extends Role {
