...
interface Creep extends RoomObject {
     ...
     */
    move: ((direction: DirectionConstant) => CreepMoveReturnCode) & ((target: Creep) => OK | ERR_NOT_OWNER | ERR_BUSY | ERR_NOT_IN_RANGE | ERR_INVALID_ARGS)
    /**
...
interface Flag extends RoomObject {
     ...
     */
    setPosition: ((x: number, y: number) => OK | ERR_INVALID_ARGS) & ((pos: RoomPosition | { pos: RoomPosition }) => OK | ERR_INVALID_ARGS)
}
...
interface Game {
     ...
     */
    getObjectById: (<T extends Id<_HasId>>(id: T) => fromId<T> | null) & (<T extends _HasId>(id: Id<T>) => T | null)
...
interface GameMap {
     ...
     */
    getTerrainAt: ((x: number, y: number, roomName: string) => Terrain) & ((pos: RoomPosition) => Terrain)
    /**
...
interface RoomPosition {
     ...
     *  STRUCTURE_LINK
     */
    createConstructionSite: ((structureType: BuildableStructureConstant) => ScreepsReturnCode) & ((structureType: STRUCTURE_SPAWN, name?: string) => ScreepsReturnCode)
    /**
    ...
    ) => S | null) & (<T extends _HasRoomPosition | RoomPosition, S extends T = T>(
        objects: T[],
        opts?: FindPathOpts &
            FilterOptions<T, S> & {
     ...
     * @param opts An object containing pathfinding options (see Room.findPath), or one of the following: filter, algorithm
     */
    findClosestByRange: (<K extends FindConstant, S extends FindTypes[K]>(type: K, opts?: FilterOptions<FindTypes[K], S>) => S | null) & (<S extends AnyStructure>(
        type: FIND_STRUCTURES | FIND_MY_STRUCTURES | FIND_HOSTILE_STRUCTURES,
        opts?: FilterOptions<FindTypes[FIND_STRUCTURES], S>,
    ) => S | null) & (<T extends _HasRoomPosition | RoomPosition, S extends T = T>(objects: T[], opts?: FilterOptions<T, S>) => S | null)
    /**
     ...
     */
    findInRange: (<K extends FindConstant, S extends FindTypes[K]>(type: K, range: number, opts?: FilterOptions<FindTypes[K], S>) => S[]) & (<S extends AnyStructure>(
        type: FIND_STRUCTURES | FIND_MY_STRUCTURES | FIND_HOSTILE_STRUCTURES,
        range: number,
        opts?: FilterOptions<FindTypes[FIND_STRUCTURES], S>,
    ) => S[]) & (<T extends _HasRoomPosition | RoomPosition, S extends T = T>(objects: T[], range: number, opts?: FilterOptions<T, S>) => S[])
    /**
     ...
     */
    findPathTo: ((x: number, y: number, opts?: FindPathOpts) => PathStep[]) & ((target: RoomPosition | _HasRoomPosition, opts?: FindPathOpts) => PathStep[])
    /**
     * Get linear direction to the specified position.
     * @param x X position in the room.
     * @param y Y position in the room.
     */
    getDirectionTo: ((x: number, y: number) => DirectionConstant) & ((target: RoomPosition | _HasRoomPosition) => DirectionConstant)
    /**
     * Get linear range to the specified position.
     * @param x X position in the room.
     * @param y Y position in the room.
     */
    getRangeTo: ((x: number, y: number) => number) & ((target: RoomPosition | { pos: RoomPosition }) => number)
    /**
     ...
     * @param range The range distance.
     */
    inRangeTo: ((x: number, y: number, range: number) => boolean) & ((target: RoomPosition | { pos: RoomPosition }, range: number) => boolean)
    /**
     * Check whether this position is the same as the specified position.
     * @param x X position in the room.
     * @param y Y position in the room.
     */
    isEqualTo: ((x: number, y: number) => boolean) & ((target: RoomPosition | { pos: RoomPosition }) => boolean)
    /**
     * Check whether this position is on the adjacent square to the specified position. The same as inRangeTo(target, 1).
     * @param x X position in the room.
     * @param y Y position in the room.
     */
    isNearTo: ((x: number, y: number) => boolean) & ((target: RoomPosition | { pos: RoomPosition }) => boolean)
    /**
...
interface Room {
     ...
     */
    getEventLog: ((raw?: false) => EventItem[]) & ((raw: true) => string)
    /**
     ...
     */
    createConstructionSite: ((x: number, y: number, structureType: BuildableStructureConstant) => ScreepsReturnCode) & ((pos: RoomPosition | _HasRoomPosition, structureType: StructureConstant) => ScreepsReturnCode) & ((x: number, y: number, structureType: STRUCTURE_SPAWN, name?: string) => ScreepsReturnCode) & ((pos: RoomPosition | _HasRoomPosition, structureType: STRUCTURE_SPAWN, name?: string) => ScreepsReturnCode)
    /**
     * Create new Flag at the specified location.
     * @param x The X position.
     * @param y The Y position.
     ...
     */
    find: (<K extends FindConstant, S extends FindTypes[K]>(type: K, opts?: FilterOptions<FindTypes[K], S>) => S[]) & (<S extends AnyStructure>(
        type: FIND_STRUCTURES | FIND_MY_STRUCTURES | FIND_HOSTILE_STRUCTURES,
        opts?: FilterOptions<FindTypes[FIND_STRUCTURES], S>,
    ) => S[])
    /**
     ...
     */
    lookAt: ((x: number, y: number) => LookAtResult[]) & ((target: RoomPosition | { pos: RoomPosition }) => LookAtResult[])
    /**
     ...
     */
    lookAtArea: ((top: number, left: number, bottom: number, right: number, asArray?: false) => LookAtResultMatrix) & ((top: number, left: number, bottom: number, right: number, asArray: true) => LookAtResultWithPos[])
    /**
     ...
     */
    lookForAt: (<T extends keyof AllLookAtTypes>(type: T, x: number, y: number) => Array<AllLookAtTypes[T]>) & (<T extends keyof AllLookAtTypes>(type: T, target: RoomPosition | _HasRoomPosition) => Array<AllLookAtTypes[T]>)
    /**
    ...
    lookForAtArea: (<T extends keyof AllLookAtTypes>(
        ...
        right: number,
        asArray?: false,
    ) => LookForAtAreaResultMatrix<AllLookAtTypes[T]>) & (<T extends keyof AllLookAtTypes>(
        type: T,
        top: number,
        left: number,
        bottom: number,
...
interface StructureContainer extends Structure<STRUCTURE_CONTAINER> {
     ...
     * amounts. Use _.sumBy(structure.store) to get the total amount of contents
     */
    store: StoreDefinition
    /**
