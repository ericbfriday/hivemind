...
Room.prototype.isClearingTerminal = function (this: Room) {
  ...
  if (
    this.storage &&
    this.roomManager &&
    this.roomManager.hasMisplacedTerminal()
  ) {
    return true;
  }
...
Room.prototype.isClearingStorage = function (this: Room) {
  ...
  if (
    this.terminal &&
    this.roomManager &&
    this.roomManager.hasMisplacedStorage()
  ) {
    return true;
  }
...
Room.prototype.getEnergyStructures = function (
  this: Room,
  ...
  return map(ids, Game.getObjectById);
};
...
function getUnmappedEnergyStructures(
  room: Room,
