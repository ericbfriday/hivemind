...
export interface StorageDestinationTask extends StructureDestinationTask {
  type: 'storage'
  target: Id<AnyStoreStructure>
}

export default StorageDestination;
export class StorageDestination extends StructureDestination<StorageDestinationTask> {
